...
const ReadyCheckCard = ({ readycheck: { title, activity, timing, owner: { username, avatar } } }) => {
    return (
        <View className="flex-col items-center px-4 mb-14 rounded-lg border border-secondary">
